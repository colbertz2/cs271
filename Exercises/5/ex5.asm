TITLE Intro to MASM(ex5.asm)

; Author: Zach Colbert
; CS 271 / Exercise 5                 Date: 1 November 2019
; Description: Assign some variables, perform some arithmetic, and learn the Irvine library.
...
prog_name       BYTE    "Intro to MASM", 0
